...
export default function SafetyCtaFooter() {
  return (
    <section
      id="s-cta"
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-[clamp(22px,4vh,42px)] text-center">
        <h2 className="m-0 max-w-[24ch] text-[clamp(26px,4.2vw,68px)] leading-[0.98] font-light tracking-[-0.025em] text-[rgb(251,247,239)] uppercase">
          Built Around Confidence, Comfort and{" "}
      ...
      <div className="mt-[clamp(50px,9vh,110px)] grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-[clamp(24px,4vw,48px)] border-t border-[rgba(240,234,221,0.12)] pt-[clamp(34px,6vh,60px)]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="font-jost flex flex-col gap-2.5 text-[12.5px] tracking-[0.08em]">
            ...
            <a href="#" className="text-[rgba(240,234,221,0.68)] transition-colors hover:text-[rgb(240,234,221)]">
              Experiences
            </a>
